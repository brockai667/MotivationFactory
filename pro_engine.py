#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""PRO engine pre DisciplineDaily reels (facts dizajn: subjektovo-presny stock, chipy so sync-om, bez mapy) (overeny na Plitvice demu, schvaleny 2026-07-04).
...
UA = {"User-Agent": "DisciplineDaily/1.0 (educational channel)"}
...
def render_overlay_seq(sc, idx, work):
    ...
    if role == "hook":
        ...
        chips[0] = {"img": chip_png("@DisciplineDaily", 58, "accent"), "at": 0.35}
...
# ---------------------------------------------------------------- render scen
GRADE = "eq=contrast=1.18:saturation=0.96:gamma=0.95,vignette=angle=PI/4.2,noise=alls=5:allf=t"
